...
// 	var actionIndices map[string]int
...
// 			"create": 1, "delete": 2, "list": 3,
// 			"pull": 4, "push": 5, "read": 6,
// 			"stop": 7, "update": 8,
// 		}
// 	} else if kind == "system" {
// 		resourceNames = []string{
...
// 	availablePerms, err := config.GetAllAvailablePermissions(kind)
// 	if err != nil {
// 		fmt.Printf("Error fetching available permissions: %v\n", err)
// 		os.Exit(1)
// 	}
// 	fmt.Println("Available permissions:", availablePerms)
...
// 	var actions []string
// 	if kind == "project" {
// 		actions = []string{"create", "delete", "list", "pull", "push", "read", "stop", "update"}
// 	} else if kind == "system" {
// 		actions = []string{"create", "delete", "list", "read", "stop", "update"}
// 	} else {
...
// 	for rowIdx, res := range grid.RowLabels {
